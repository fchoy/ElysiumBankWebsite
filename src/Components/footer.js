...
const footer = () => {
  return (
    <Container fluid="true" className="d-flex flex-lg-row flex-column mt-3 mb-3 justify-content-center align-items-center">

      <Row className="row col-lg-4 col-md-auto col-12 d-flex flex-column h-75 mb-lg-0 mb-5 footer-row">
      ...
      <Row className="row col-lg-4 col-12 d-flex flex-column mb-lg-0 mb-5 h-auto footer-row">
      ...
      <Row className="row col-lg-4 col-auto d-flex flex-column mb-lg-0">
