    ...
    <Container fluid="true" className="d-flex flex-lg-row flex-column mt-3 mb-3 justify-content-center align-items-center h-auto">
      ...
      <Row className="row col-lg-4 col-md-auto col-12 d-flex flex-column h-75 mb-lg-0 mb-5 footer-row m-auto">
        ...
        <Col className="col-6 w-auto h-auto text-center d-flex flex-column flex-md-row justify-content-center align-items-center mb-md-0 mb-3">
          <a href="https://facebook.com" rel="noreferrer" target='_blank' className='col-lg-2 col-12'><i className="bi bi-facebook" style={{fontSize: "2rem", cursor : "pointer", color: "blue"}}/></a>
          <a href="https://instagram.com" rel="noreferrer" target='_blank' className='col-lg-2 col-12'><i className="bi bi-instagram col-lg-2 col-12" style={{fontSize: "2rem", cursor : "pointer", color: "hotpink"}}/></a>
          <a href="https://twitter.com" rel="noreferrer" target='_blank' className='col-lg-2 col-12'><i className="bi bi-twitter col-lg-2 col-12" style={{fontSize: "2rem", cursor : "pointer", color: "light-blue"}}/></a>
        </Col>
      </Row>
      ...
      <Row className="row col-lg-4 col-12 d-flex flex-column m-auto mb-lg-0 mb-5 h-auto footer-row">
        ...
        <Col className="h-auto">
          <Form className="w-75 col-md-12 m-auto d-flex flex-row h-auto mb-md-0 mb-5" onSubmit={formSubmit}>
